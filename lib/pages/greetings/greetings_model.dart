...
class GreetingsModel extends FlutterFlowModel<GreetingsWidget> {
  ...
  String? _textController2Validator(BuildContext context, String? val) {
    ...
    if (!RegExp(kTextValidatorEmailRegex).hasMatch(val)) {
      return 'Mohon periksa kembali alamat email anda.';
    }
    return null;
  }
  ...
  String? _textController3Validator(BuildContext context, String? val) {
    ...
    if (val.length < 10) {
      return 'Minimum 10 digit nomor telepon.';
    }

    return null;
  }

  // Stores action output result for [Backend Call - API (setsendleads)] action in Button widget.
  ApiCallResponse? respSetSendLeads;
